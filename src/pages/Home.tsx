export default function Home() {
  return (
    <div>
      <h1>Welcome</h1>
      <p>Welcome to my website! I document my projects and experiments here in robotics, AI, computer graphics and more in the future. This serves as a portfolio but feel free to use any code or methods, as everything I share is opensource under the MIT licence. If you want to explore my computer graphics experiments I would recommend activating WebGPU flags in your browser (and use chrome if you're running linux).</p>
      <h1>About me</h1>
